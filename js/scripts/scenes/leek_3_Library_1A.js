const leek_3_Library_1A = {
  'leek_3_Library_1A_start': [
    ...
    '<p class = "italicText">I walk in a few minutes before the time we agreed to meet up, just to take a look around.</p>',
    ...
    'Oh, there she... huh?',
    '<p class = "italicText">I peek my head around a shelf, but pause for a second from what I see. Leek is sitting at one of the small tables, her laptop set up with a few loose papers and books laid out around it.</p>',
    '<p class = "italicText">She looks deep in thought as she focuses on her work and…hums?</p>',
    'play voice leek_library1A_1',
    'show character leek sigh with fadeIn',
    'leek:sigh <p class = "italicText">*soft humming...</p>',
    'Cute...',
    ...
    'stop voice leek_library1A_1',
    'play voice leek_library1A_2',
    ...
    'play voice leek_library1A_3',
    "leek:laugh You're terrible...",
